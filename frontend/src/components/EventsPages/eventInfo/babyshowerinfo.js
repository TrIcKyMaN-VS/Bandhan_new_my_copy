...
return(
    ...
    <tr>
     ...
     <div class="my-5" />
      <div>
        <h3 className=" text-center fw-bold mb-2" style={{"fontVariant": "small-caps", "display": "block"}}>{props.personalbabyshower.eventName} - [ {props.personalbabyshower.date} ]</h3>
  
        <h5 className="text-center fw-bold text-muted mb-3" >Order ID - <span className="fs-6" style={{color:"limegreen"}}>[ {props.personalbabyshower.orderId} ]</span></h5>
