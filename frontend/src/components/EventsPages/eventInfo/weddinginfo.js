...
import axios from 'axios'
 ...
 export function Weddinginfo(props) {
  ...
  function refreshPage(){ 
    axios
      .post(`api/eventInfo/weddingcancel/${props.personalwedding.orderId}`)
...
return(
    ...
    <tr>
     ...
     <div class="my-5" />
      <div>
        <h3 className=" text-center fw-bold mb-2" style={{"fontVariant": "small-caps", "display": "block"}}>{props.personalwedding.eventName} - [ {props.personalwedding.date} ]</h3>
  
        <h5 className="text-center fw-bold text-muted mb-3" >Order ID - <span className="fs-6" style={{color:"limegreen"}}>[ {props.personalwedding.orderId} ]</span></h5>
        ...
        <div className="row justify-content-center">
         ...
         <tbody>
               ...
               <th>Mehandi</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Mehandi.DateMehandiShow}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Mehandi.TimeMehandiShow}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
               ...
               <th>Sangeet</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Sangeet.DateSangeet}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Sangeet.TimeSangeet}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
               ...
               <th>Pooja</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Pooja.DatePooja}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Pooja.TimePooja}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
               ...
               <th>Baraat</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Baraat.DateBaraat}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Baraat.TimeBaraat}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
               ...
               <th>Reception</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Reception.DateReception}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Reception.TimeReception}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
               ...
               <th>Phera</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Phera.DatePhera}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Phera.TimePhera}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
               ...
               <th>Tilak</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Tilak.dateTilak}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Tilak.TimeTilak}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
               ...
               <th>Haldi</th>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Haldi.DateHaldi}
                    type={"date"}
                    className={"input-sm"}
                  />
                </td>
                <td className="text-start ps-0 ms-0 pe-5">
                  <input
                    value={props.personalwedding.Servicevalue.Haldi.TimeHaldi}
                    type={"time"}
                    className={"input-sm"}
                  />
                </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"><h4>Are you sure want to cancel order</h4></div>
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" data-mdb-dismiss="modal">Close</button>
        <button type="button" class="btn btn-danger" onClick={(val)=>refreshPage() }>Proceed</button>
      </div>
    </div>
  </div>
</div>
              ...
              <tr>
                    ...
                    <td colspan="2">{props.personalwedding.cancelstatus}</td>
        
                  </tr>
                  {props.personalwedding.canceled && (<tr>
                    <th scope="row" className="fw-bold">Refund Amount</th>
                     <td colspan="2">{props.personalwedding.refund}</td>
                  </tr>
                  )}
              </tbody>
              </table>
